    ...
    public void imprimirFactura(){
        ...
        for(int i = 0; i < listaFacturas.length; i++){
            if(listaFacturas[i] != null){
                ...
                etqTemporal = new JLabel(" " + listaFacturas[i].getId()+" - "+listaFacturas[i]. getCedulaCliente()+" "+listaFacturas[i].getCedulaVendedor()+" - "+" - "+listaFacturas[i].getTotal());
                ...
                String cedula_cliente = listaFacturas[i].getCedulaCliente();
                String cedula_vendedor = listaFacturas[i].getCedulaVendedor();
