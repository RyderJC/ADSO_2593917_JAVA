...
import ModuloUsuarios.EliminarCliente;
...
public class Menu extends JFrame {
    ...
    private void btnEliminarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarClienteActionPerformed
         EliminarCliente ventana = new EliminarCliente(this,  this.listaClientes, "CLIENTES");
         ventana.setVisible(true);
          setVisible(false);
    ...
    private void btnEliminarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarVendedorActionPerformed
            EliminarCliente ventana = new EliminarCliente(this, this.listaVendedores, "VENDEDORES");
            ventana.setVisible(true);
             setVisible(false);
